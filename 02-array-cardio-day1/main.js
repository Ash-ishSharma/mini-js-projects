...
console.log({ oldestSorted: oldest });

// 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
// const categoryDiv = document.querySelector(".mw-category");
// const allLinks = Array.from(categoryDiv.querySelectorAll("a"));
// const de = allLinks
...
const sortingPeople = peopleArray.sort((a, b) => {
  const aPerson = a[1];
  const bPerson = b[1];
  return aPerson < bPerson ? -1 : 1;
});
console.log({ sortedPeople: sortingPeople });
